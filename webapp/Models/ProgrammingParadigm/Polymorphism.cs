...
{
    public class Polymorphism : Basis
    {
        public override string GetDefinition()
        {
            return @"<h2>Polimorfismo</h2>
                    
                    Comportamientos diferentes, asociados a 
                    objetos distintos, pueden compartir el mismo 
                    nombre;
                    <br><br>
                    Los diferentes objetos responden de diferentes 
                    maneras a los mismos mensajes
                    <br><br>
                    Herencia + Enlace dinámico = Polimorfismo";
        }
    }
}
